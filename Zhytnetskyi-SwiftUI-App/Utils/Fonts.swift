...
struct Fonts {
    ...
    static let input = Font.system(size: 24, weight: .semibold)
    static let longInput = Font.system(size: 20, weight: .regular)
    
    static let button = Font.system(size: 22, weight: .medium)
}
